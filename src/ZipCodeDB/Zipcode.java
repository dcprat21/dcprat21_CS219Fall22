    ...
    public WeatherObservation getWeatherData(){
        ...
        while (s.hasNextLine()){
            ...
            if (line.indexOf("speed")>0){
                ...
                String speedLine = line.substring(line.indexOf('\"') , line.indexOf('\"'));
            ...
            if (line.indexOf("temp")>0){
                ...
                // String tempLine = line.substring(line.indexOf('\"') , line.indexOf('\"'));
            ...
            if (line.indexOf("clouds")>0){
                String cloudsLine = line.substring(line.indexOf(':') + 1, line.indexOf(','));
                clouds = cloudsLine;
            }
...
// how to get temp without using replace